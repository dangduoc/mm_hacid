...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20201119103655_add bannersetting")]
    partial class addbannersetting
    {
            ...
            modelBuilder.Entity("Domain.Entities.BannerSetting", b =>
                {
                    ...
                    b.Property<string>("HomeProject1")
                        .HasColumnType("varchar(200)")
                        .HasMaxLength(200)
                        .IsUnicode(false);

                    b.Property<string>("HomeProject2")
                        .HasColumnType("varchar(200)")
                        .HasMaxLength(200)
                        .IsUnicode(false);

                    b.Property<string>("HomeProject3")
                        .HasColumnType("varchar(200)")
                        .HasMaxLength(200)
                        .IsUnicode(false);

                    b.Property<string>("HomeProject4")
                        .HasColumnType("varchar(200)")
                        .HasMaxLength(200)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("Domain.Entities.HomeBanners", b =>
                {
                    b.HasOne("Domain.Entities.Project", "Project")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.HomeBanners", "ProjectId")
