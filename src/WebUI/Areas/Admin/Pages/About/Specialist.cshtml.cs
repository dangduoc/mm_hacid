...
namespace BaseProjectWebRazor.Areas.Admin.Pages.About
{
    public class SpecialistModel : PageModel
    {
        ...
        public SpecialistModel(IApplicationDbContext context
            )
        {
            _context = context;
        }
        ...
        {
            var entity = await _context.AboutArticle.Where(c => c.Type == (int)Domain.Entities.AboutArticleTypeEnum.Specialist).FirstOrDefaultAsync();
