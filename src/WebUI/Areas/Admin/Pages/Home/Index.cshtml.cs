...
namespace BaseProjectWebRazor.Areas.Admin.Pages.Home
{
    public class HomePageModel : PageModel
    {
        ...
        public HomePageModel(IApplicationDbContext context
            )
        {
            _context = context;
        }
        ...
        {
            var entity = await _context.AboutArticle.Where(c => c.Type == (int)Domain.Entities.AboutArticleTypeEnum.Home).FirstOrDefaultAsync();
